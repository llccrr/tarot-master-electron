    ...
    render() {
        ...
        return (
            <section style={styles.section}>
                ...
                />
                <TextInput onChange={this.setPlayer('lastname')} style={styles.textInputs} placeholder="Nom" />
                <Button onClick={this.addNewPlayer} style={styles.textInputs} disabled={loading}>
